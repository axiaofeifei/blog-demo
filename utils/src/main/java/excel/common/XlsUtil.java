...
import com.lovol.security.common.excel.bean.Field;
import com.lovol.security.common.excel.generater.GenXml;
import jxl.*;
...
public class XlsUtil {
     ...
     * @throws Exception
     */
    public static List<String> getHeader(ExcelConfig config, Workbook wb) throws Exception {
        ...
        if(rowLength>0) {
            for (int j = 0; j < length; j++) {
                headers.add(getCellValue(sheet.getCell(j, 0)).toString());
            }
        }
        return headers;
    }
